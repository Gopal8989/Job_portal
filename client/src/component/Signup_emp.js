...
class Signup_emp extends React.Component {
  constructor() {
    super();
    this.state = {
      fields: {},
    ...
    this.Signup_emp = this.Signup_emp.bind(this);
  }
  ...
  // configPass=(ps)=>{
  //   let p1=document.getElementById('password2').value;
  //   let p2=ps.target.value;
  //   let errors=document.getElementById('passerrors');
  //   if(p2==="" || p1===p2)
  //   errors.innerHTML="";
  //   if(p1!==p2)
  //   errors.innerHTML="Password Not Match!!!!";
  // }
  ...
  validateFrom() {
    ...
    if (!fields["last"]) {
      formIsValid = false;
      errors["last"] = "*Please enter your lastName.";
    }
    ...
    if (typeof fields["password"] !== "undefined") {
      ...
      var patternn = new RegExp(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,16})/);
    ...
    //   errors["password2"] = "*enter confrom_password.";
    // }
        ...
        <form onSubmit={this.Signup_emp}>
          ...
          <div className="input-group form-row mb-4">
            ...
            <div className="custom-file">
              ...
              />
              <label className="custom-file-label">CAMPANY_id</label>
            </div>
          </div>
